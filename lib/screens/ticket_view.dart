...
import 'package:app_demo_ticket/widgets/column_layout.dart';
import 'package:app_demo_ticket/widgets/layout_builder_widget.dart';
...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: AppLayout.getHeight(GetPlatform.isAndroid==true?180:182),
      child: Container(
        ...
        child: Column(
          ...
          children: [
                      ...
                      Expanded(child: Stack(
                        children: [
                          ...
                          Center(child: Transform.rotate(
                            angle: 1.6,
                            child: Icon(Icons.local_airport_rounded, color: isColor==null? Colors.white: Color(0xFFBACCF7)),
                            ),
                          )
                        ])
                      ),
             ...
             */
            Container(
              color: isColor==null? const Color(0xFFF37B67): Colors.white, //Styles.orangeColor, 
              child: Row(
                children: [
                  SizedBox(
